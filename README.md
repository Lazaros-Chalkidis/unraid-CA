...
This repository contains the XML metadata files for [Community Applications](https://ca.unraid.net/) plugin listings.
...
| [Files Viewer](https://github.com/Lazaros-Chalkidis/unraid-filesviewer) | Browse your Unraid shares and disks from a page under Tools, preview files in place, and manage them without leaving the browser |
| [Aegis MFA](https://github.com/Lazaros-Chalkidis/unraid-aegis-mfa) | Two-factor authentication for the Unraid webGUI |
